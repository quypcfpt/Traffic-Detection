...
##video_path = [CWD_PATH + "/video/MVI_4012_1.avi"]
video_path = ["video17.avi"]
...
##                cv2.line(image,(0,511),(width,511),(255,0,0),5)
                ...
                for e in size_values:
                        ...
                        for i in range(len(distList)):
                                addValue(distList[i], arr4[i])
                        for keys,values in finalData.items():
                                print('keys :' + str(keys) + " in frame_" + str(count))
                                print('values :' + str(values) + " in frame_" + str(count))

                        od=collections.OrderedDict(sorted(finalData.items()))
                        ...
                        for keys,values in od.items():
                            ...
                            if(values == 'free'):
                              countFree+=1;
                        print('crowded :',countCrowded)
                        number_crowded.append(countCrowded)
                        print('free :',countFree)
                        number_free.append(countFree)
                        if(countCrowded>countFree):
                          print('Crowded ' + " in frame_" + str(count))
                        else:
                          print('Free ' + " in frame_" + str(count))
            ...
            if ((count%(30*fps) == 0) & (count != 0)) :
                    ...
                    status = 0;
                    print('SAU 30S:   ')
                    print(len(number_crowded))
                    print(len(number_free))
                    if(len(number_crowded) > len(number_free)):
                            print('crowed')
                            status=1;
