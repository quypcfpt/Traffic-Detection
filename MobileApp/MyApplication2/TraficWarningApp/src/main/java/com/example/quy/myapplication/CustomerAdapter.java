...
public class CustomerAdapter extends ArrayAdapter<DataModel> implements View.OnClickListener{
private final String Extra_MEss = "com.example.quy.myapplication";
    ...
    public CustomerAdapter(ArrayList<DataModel> data, Context context) {
