...
PIPELINE_CONFIG_LOC =  "faster_rcnn_inception_v2.config"

# the final checkpoint result of the training process
TRAINED_CHECKPOINT_PREFIX_LOC ="faster_rcnn_inception_v2_training_data/model.ckpt-99290"
...
OUTPUT_DIR =  "faster_rcnn_inception_v2_99k_result"
