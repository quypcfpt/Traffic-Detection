...
TRAIN_CSV_FILE_LOC ="faster_rcnn_inception_v2_training_data/" + "train_labels.csv"
TRAIN_IMAGES_DIR = "train_frames"

# input test CSV file and test images directory
EVAL_CSV_FILE_LOC ="faster_rcnn_inception_v2_training_data/" + "eval_labels.csv"
TEST_IMAGES_DIR = "test_frames"

# training and testing output .tfrecord files
TRAIN_TFRECORD_FILE_LOC = "faster_rcnn_inception_v2_training_data/" + "train.tfrecord"
EVAL_TFRECORD_FILE_LOC = "faster_rcnn_inception_v2_training_data/" + "eval.tfrecord"
...
def classAsTextToClassAsInt(classAsText):
    ...
    if classAsText == 'motor':
        print ('motor')
        return 1
    elif classAsText == 'car':
        print ('car')
        return 2
    elif classAsText == 'truck':
        print ('truck')
        return 3
    elif classAsText == 'bus':
        print ('bus')
        return 4
    elif classAsText == 'container':
        print ('container')
        return 5
    else:
        print("error in class_text_to_int(), row_label could not be identified" +" -- "+ classAsText)
        return -1
    # end if
# end function
